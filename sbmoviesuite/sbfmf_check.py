...
Options:
  ...
  -b BOUNDFILENAME, --boundfile=BOUNDFILENAME
			...
			Default = "/groups/flyprojects/home/olympiad/bin/sbmoviesuite/sbfmf_bounds.txt"
  -d DATAFILENAME, --datafile=DATAFILENAME
                        Name of text file containing all the data output in the previous step. 
			Default = "/groups/flyprojects/home/olympiad/bin/sbmoviesuite/sbfmf_data.txt"
...
{noformat}
isok: 1
field,isinbounds,prctless,prctmore
...
def main():
    ...
    parser.add_option("-b", "--boundfile", dest="boundfilename", default="/groups/flyprojects/home/olympiad/bin/sbmoviesuite/sbfmf_bounds.txt",
                      help="optional bound file name")
    parser.add_option("-d", "--datafile", dest="datafilename", default="/groups/flyprojects/home/olympiad/bin/sbmoviesuite/sbfmf_data.txt",
    ...
    for sbfmfname in args:
        ...
        fid.write('field,isinbounds,prctless,prctmore\n')
