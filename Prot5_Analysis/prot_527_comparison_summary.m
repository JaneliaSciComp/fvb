...
elseif strcmp(exp_group2,'controls')
...
if plot_mode == 1
    suptitle('Protocol 5.27 Comparison Summary')
end

if plot_mode == 2
    suptitle('Protocol 5.27 Comparison Summary - Individual Tubes with Mean')
end

if plot_mode == 3
    suptitle('Protocol 5.27 Comparison Summary - Repeated Experiments')
end
