function exp_detail = prot_522_analysis(exp_directory, save_plots, folder_path, temp, phase, AD, protocol, analysis_version)
...
if phase == 1,
    ...
    dir1_starts = [125,625,1125,1625,2125,2625,3125,3625];
    dir2_starts = [375,875,1375,1875,2375,2875,3375,3875];
    trial_length = 100;
    ma_points = 8; % number of points to use in ma smoothing of the velocity plot
    plot_conditions = [0.1, 0.4, 0.7, 1, 1, 0.7, 0.4, 0.1]; %stimulus speeds
    x_variable = 'Contrast';
    main_title = 'Contrast with Low, Constant Average Intensity';
    ...
    %% seq2, contrast series w. same average intensity
    ...
    %% seq3, contrast series w. increasing intensity
...
if phase == 2
   ...
   %% Repeat of phase 1
   %% seq5, contrast series w. same average intensity
    ...
    %% seq4, contrast series w. same average intensity
    ...
    %% seq6, contrast series w. increasing intensity
