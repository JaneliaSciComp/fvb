function exp_detail = prot_524_analysis(exp_directory, save_plots, folder_path, temp, phase, AD, protocol, analysis_version)
...
if phase == 1,
    ...
    plot_conditions = [0.67 2 5 10 20 42 42 20 10 5 2 0.67]; %stimulus speeds
    x_variable = 'Temporal Freqency';
    main_title = 'Reverse Phi 4pix';
