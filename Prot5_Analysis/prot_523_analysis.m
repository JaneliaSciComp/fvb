function exp_detail = prot_523_analysis(exp_directory, save_plots, folder_path, temp, phase, AD, protocol, analysis_version)
...
if phase == 1,
    ...
    plot_conditions = [0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4, 0.4]; %stimulus speeds
    x_variable = 'Contrast';
    main_title = '0.4 contrast run1';
...
if phase == 2
    ...
    %% seq5, contrast series w. increasing intensity
