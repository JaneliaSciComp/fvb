function exp_detail = prot_517_analysis(exp_directory, save_plots, folder_path, temp, phase, AD, protocol, analysis_version)
...
if phase == 1,
    ...
    dir1_starts = [175,775,1375,1975,2575,3175,3775,4375,4975,5575];
    dir2_starts = [475,1075,1675,2275,2875,3475,4075,4675,5275,5875];
    trial_length = 100;
