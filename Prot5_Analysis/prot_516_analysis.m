function exp_detail = prot_516_analysis(exp_directory, save_plots, folder_path, temp, phase, AD, protocol, analysis_version)
...
if phase == 1,
    ...
    dir1_starts = [125,1375,2625,3875,5125,6375,7625,8875,10125,11375];
    dir2_starts = [750,2000,3250,4500,5750,7000,8250,9500,10750,12000];
    trial_length = 100;
