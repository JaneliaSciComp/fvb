...
for temp_ind = 1:1 %for two temps
    for seq_ind = 1:5 %num_seqs 
        ...
        for tube_ind = 1:6 %num_tubes
            ...
            mov_str{row_ind,tube_ind} = [Temp_str{temp_ind} '_4.0_seq' num2str(seq_ind) '_tube' num2str(tube_ind)];
        ...
        an_save_path = [outDir filesep 'Output' filesep Temp_prot_str{temp_ind} filesep Temp_str{temp_ind} '_4.0_seq' num2str(seq_ind) '_analysis_info.mat'];
        try
