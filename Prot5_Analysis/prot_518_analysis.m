function exp_detail = prot_518_analysis(exp_directory, save_plots, folder_path, temp, phase, AD, protocol, analysis_version)
...
if phase == 1,
    ...
    main_title = 'Optomotor Response to 11/4 Contrast';
    ...
    plot_conditions = [0 0.67 2 5 10 20 42 42 20 10 5 2 0.67 0]; %stimulus speeds
    x_variable = 'Temporal Freqency';
    main_title = 'Optomotor Response to 13/2 Contrast';
    ...
    plot_conditions = [0 0.67 2 5 10 20 42 42 20 10 5 2 0.67 0]; %stimulus speeds
    x_variable = 'Temporal Freqency';
    main_title = 'Optomotor Response to 15/0 Contrast';
...
if phase == 2
    ...
    plot_conditions = [0 0.67 2 5 10 20 42 42 20 10 5 2 0.67 0]; %stimulus speeds
    x_variable = 'Temporal Freqency';
    main_title = 'Optomotor Response to 15/6 Contrast';
    ...
    plot_conditions = [0 0.67 2 5 10 20 42 42 20 10 5 2 0.67 0]; %stimulus speeds
    x_variable = 'Temporal Freqency';
    main_title = 'Optomotor Response to 15/3 Contrast';
