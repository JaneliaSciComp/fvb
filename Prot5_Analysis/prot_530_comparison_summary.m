function prot_527_comparison_summary(BoxData,exp_group1,exp_group2, ...
...
if strcmp(exp_group2,'controls')
    
    exp_group2_data = BoxData(strcmp({BoxData.type},'control'));
...
if plot_mode == 1 || plot_mode == 2
    text(15, 0.25*y_lim_DI, ... 
             exp_group1_data.genotype, ...
             'HorizontalAlignment', 'right', ...
             'Interpreter', 'none', ...
             'FontSize', 14, ...
             'Color', 'k', ...
             'BackgroundColor',[1 1 1])
    text(15, 0.25*y_lim_DI-0.1, ... 
             exp_group1_data.date_time, ...
             'HorizontalAlignment', 'right', ...
             'Interpreter', 'none', ...
             'FontSize', 14, ...
             'Color', 'k', ...
...
if plot_mode == 1
    suptitle('Protocol 5.30 Comparison Summary')
end

if plot_mode == 2
    suptitle('Protocol 5.30 Comparison Summary - Individual Tubes with Mean')
end

if plot_mode == 3
    suptitle('Protocol 5.30 Comparison Summary - Individual Tubes')
end

if saveplot == 1
    save2pdf([exp_group1_data(1).path filesep 'Output_1.1_1.7/' pdfname '.pdf']);
end