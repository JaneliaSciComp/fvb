function plotduplicates_bothmeans
...
load('/Volumes/flyvisionbox/oldBoxData.mat');
...
savepath = '/Volumes/flyvisionbox/comparison_summaries/repeats/Mean_CS';
    ...
    if ~ismember(all_lines(line),controls)
        ...
        for prot = 1:length(protocols_for_this_line)
            ...
            if ~exist([savepath,data(1).line_name,'_',data(1).effector,'_combined_summaries.pdf'],'file')
                ...
                prot_527_comparison_summary(BoxData,{data.experiment_name},...
