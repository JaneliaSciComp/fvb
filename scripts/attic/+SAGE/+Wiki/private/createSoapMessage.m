...
% Modified by Frank Midgley, November 2011
% Added base64 encoding for uint8 vectors (lines 136 & 137)
...
switch class(x)
    case 'char'
        s = x;
    case 'uint8'
        s = char(org.apache.commons.codec.binary.Base64.encodeBase64(x));
    otherwise
        s = mat2str(x);
end