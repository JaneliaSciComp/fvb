...
if phase == 1,
    ...
    dir1_starts = [262,1012,1762,2512];
    dir2_starts = [637,1387,2137,2887];
    trial_length = 100;
    ma_points = 8; % number of points to use in ma smoothing of the velocity plot
    plot_conditions = ['light,dark,light/dark,dark/light']; %stimulus speeds
    x_variable = 'Stimulus';
    main_title = 'Minimal Motion';
    ...
    minimal_motion_analysis;
    
    %% seq2, ReversePhi, 2pix
    sequence = 'seq2';
    min_num_flies = 2; % minimum number of flies in tubes
    del_t = 1/25; %inverse frames per second
    ...
    plot_conditions = [0 0.67 2 5 10 20 42 42 20 10 5 2 0.67 0]; %stimulus speeds
    x_variable = 'Temporal Freqency';
    main_title = 'Reverse Phi, 4pixels';
