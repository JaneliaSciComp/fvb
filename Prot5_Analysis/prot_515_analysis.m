function exp_detail = prot_515_analysis(exp_directory, save_plots, folder_path, temp, phase, AD, protocol, analysis_version)
...
if phase == 1,
    ...
    x_variable = 'Spatial Frequency (# on/ # off)';
    main_title = 'On/Off Intensity = 1/0';
    try
    ...
    plot_conditions = [1, 2, 3, 4, 6, 8, 16, 16, 8, 6, 4, 3, 2, 1]; %stimulus speeds
    x_variable = 'Spatial Frequency (# on/ # off)';
    main_title = 'On/Off Intensity = 3/0';
    try
    ...
    plot_conditions = [1, 2, 3, 4, 6, 8, 16, 16, 8, 6, 4, 3, 2, 1]; %stimulus speeds
    x_variable = 'Spatial Frequency (# on/ # off)';
    main_title = 'On/Off Intensity = 15/0';
